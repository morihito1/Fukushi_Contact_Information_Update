...
- [SAP Automation Guide](references/sap-guide.md) - Read before authoring SAP automation. Covers input mode, SAP GUI (WinGUI) specifics, selectors, transactions vs programs, and common gotchas
...
| Activity | Description |
|----------|-------------|
| [Call Transaction](activities/SAPCallTransaction.md) | Executes a transaction code in the current SAP GUI window. |
